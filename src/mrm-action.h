...
class ActionRobot : public ActionBase {
	void perform();
public:
	ActionRobot(Robot* robot, const char shortcut[4], const char text[20], uint8_t menuLevel = 1, Board::BoardId boardsId = Board::BoardId::ID_ANY,
		Mrm_8x8a::LEDSign* ledSign8x8 = NULL,  void (Robot::*actionPerform)() = NULL) : 
		ActionBase(robot, shortcut, text, menuLevel, boardsId, ledSign8x8, actionPerform) {}
};